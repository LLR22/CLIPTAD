...
from dataset.label.action import id_to_action
...
class WWADLDatasetTestSingle():
    ...
    def __init__(self, config, modality=None, device_keep_list=None):
        ...
        self.clip_length = segment_info['window_len'] # my debug
        # self.stride = segment_info[modality]['window_step']
        self.stride = segment_info['window_step'] # my debug
    ...
    def load_global_stats(self):
        ...
        stats_path = os.path.join('/home/yanrui/code/CLIPBased_TAD/dataset/cache/', "global_stats.json")
