...
import numpy as np
from dataset.test.wwadl_test import WWADLDatasetTestSingle
from utils.evaluation.softnms import softnms_v2
from utils.evaluation.eval_detection import ANETdetection
...
class Tester(object):
    def __init__(self,
        ...
        if pt_file_name is None:
            ...
            # pt_file_name = 'clip_mamba_getfusionweight-epoch-78.pt'
